        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <RevealOnScroll>
            <div className="relative group">
              ...
              <img src="/new-lutecia-photo.jpeg" alt="Lutécia Rustico" className="relative w-full max-w-md mx-auto object-cover rounded-2xl border border-white/10 shadow-2xl transform group-hover:scale-[1.02] transition-transform duration-500 grayscale hover:grayscale-0" />
            </div>
          </RevealOnScroll>
          <RevealOnScroll delay={200}>
            <div>
