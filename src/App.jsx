...
const PROJECTS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'image', url: 'Flyer-Save the date-CR.jpg' },
      { type: 'image', url: 'Flyer-CR-Caroussel-P1.jpg' },
      { type: 'image', url: 'Flyer-CR-Caroussel-P2.jpg' },
      { type: 'image', url: 'Flyer-CR-Caroussel-P3.jpg' },
      { type: 'image', url: 'Flyer-CR-Caroussel-P4.jpg' },
      { type: 'image', url: 'Flyer-CR-Caroussel-P5.jpg' },
      { type: 'image', url: 'Flyer-CR-Caroussel-P6.jpg' },
      { type: 'image', url: 'Flyer-CR-Caroussel-P7.jpg' },
      { type: 'image', url: 'CR-Maitre-de-cérémonie.jpg' },
      { type: 'image', url: 'CR-icone.jpg' },
      { type: 'image', url: 'CR-Hôtesse.jpg' },
      { type: 'image', url: 'CR-Sécurité.jpg' },
      { type: 'image', url: 'CR-Mockup- Badge.jpg' },
      { type: 'image', url: 'CR-Story-Design.png' },
      { type: 'image', url: 'CR-Photocall-shooting-Mockup.jpg' },
      { type: 'video', url: 'CR-Animation-logo.mp4' },
      { type: 'video', url: 'CR-After-Film.mp4' }
    ]
  },
  {
    id: 4,
